...
from src.data.SSTDataset import SSTDataset
...
class SSTDataModule(L.LightningDataModule):
    ...
    def setup(self, stage: str):
        ...
        if stage == "fit":
            ...
            self.train_dataset = SSTDataset(self.data_dir,
                                                  self.data_config,
                                                  self.train_ids)
            self.val_dataset = SSTDataset(self.data_dir,
                                                self.data_config,
                                                self.val_ids)

        # Assign test dataset for use in dataloader(s)
        if stage == "test":
            self.test_dataset = SSTDataset(self.data_dir,
                                                 self.data_config,
                                                 self.test_ids)
